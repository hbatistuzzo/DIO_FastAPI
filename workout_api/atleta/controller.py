...
from sqlalchemy.exc import IntegrityError #necessario importar este modulo para a verificação do cpf duplicado
...
async def post(
    ...
    # o except original abaixo é substituído pelo except acima que verifica se o cpf é duplicado
    # except Exception:
    #     raise HTTPException(
